...
def set_output_directory():
    ...
    old = output_dir
    global output_lbl
    output_dir = filedialog.askdirectory(parent=configure_window, title='Choose the Directory to output Segmented Images',
...
def configuration_window():
        ...
        kernel_size_input = customtkinter.CTkEntry(master=configure_window, placeholder_text="Keral size", textvariable=kernel_size_var)
        ...
        kernel_deviation_input = customtkinter.CTkEntry(master=configure_window, placeholder_text="Keral size", textvariable=kernel_deviation_var)
        ...
        mCherry_input = customtkinter.CTkEntry(master=configure_window, placeholder_text="Keral size", textvariable=mCherry_var)
        ...
        # mCherry switch
        mCherry_toggle = customtkinter.CTkSwitch(master=configure_window, text="mCherry to find pairs", command=mCherry_switch_event,
        ...
        ok_btn.grid(row=7, column=0, padx=10, pady=10)
